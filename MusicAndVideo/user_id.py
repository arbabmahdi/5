...
@Client.on_message(filters.command(["id","ایدی"], prefixes=f"{HNDLR}"))
async def showid(_, message: Message):
    ...
    if chat_type == "private":
        ...
        _id = ""
        _id += "<b>ایدی گروه</b>: " f"<code>{message.chat.id}</code>\n"
        if message.reply_to_message:
            ...
            _id += "<b>ایدی شما</b>: " f"<code>{message.from_user.id}</code>\n"
